...
import { Linkedin, Github, Compass, Send, Phone, MessageCircle } from "lucide-react";
      ...
      <div className="w-full px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          ...
          <div className="flex-1">
            ...
            <a 
              href="mailto:audreydohou23@gmail.com" 
              className="text-2xl md:text-3xl text-[#FAF5F0] opacity-70 hover:opacity-100 transition-opacity duration-300 border-b-2 border-[#FAF5F0]/30 pb-2 font-light inline-block mb-20"
            >
            ...
            <div className="flex flex-col md:flex-row gap-16 md:gap-24">
              ...
              {/* RÉSEAUX & CONTACTS */}
              <div className="text-left">
                <p className="text-[12px] uppercase tracking-[0.4em] text-[#FAF5F0]/50 mb-8 font-bold">
                  Réseaux & Contact
                </p>
                <ul className="space-y-5 text-xl md:text-2xl font-medium italic text-[#FAF5F0]">
                  <li>
          ...
          <div className="w-full lg:w-[420px] bg-[#362d29] p-10 rounded-[40px] border border-[#FAF5F0]/10 shadow-2xl shrink-0">
            <p className="text-[12px] uppercase tracking-[0.4em] text-blue-600 mb-10 font-bold">
              Envoyer un message
            </p>
            ...
            <form className="space-y-10">
              <div>
                <input 
                  ...
                  className="w-full bg-transparent border-b border-[#FAF5F0]/20 py-3 outline-none focus:border-blue-600 transition-colors text-lg font-light text-[#FAF5F0] placeholder:text-[#FAF5F0]/30"
                />
              </div>
              <div>
                <input 
              ...
              <div>
                <textarea 
                  ...
                  className="w-full bg-transparent border-b border-[#FAF5F0]/20 py-3 outline-none focus:border-blue-600 transition-colors text-lg font-light text-[#FAF5F0] placeholder:text-[#FAF5F0]/30 resize-none"
                />
              </div>
              
              <button className="w-full group flex items-center justify-center gap-3 bg-blue-600 text-white py-4 rounded-2xl font-bold uppercase text-[10px] tracking-[0.2em] hover:bg-[#FAF5F0] hover:text-blue-600 transition-all duration-300 shadow-lg shadow-blue-600/20">
